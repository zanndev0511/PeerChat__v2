...
export declare type TeleBoxCoord = {
    x: number;
    y: number;
};
export declare type TeleBoxSize = {
    width: number;
    height: number;
};
export declare type TeleBoxState = `${TELE_BOX_STATE}`;
...
export interface TeleBoxDelegateEvents extends EventEmitter<TeleBoxDelegateEvent> {
