...
function replay(player, div, options) {
  const replayFastboard = new fastboardUi.ReplayFastboard({ target: div, props: __spreadValues({ player }, options) });
  return {
    update(props) {
      if (props)
