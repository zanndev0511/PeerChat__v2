 ...
 */
export declare class ShapeStyleForUpdate {
    /**
     ...
     */
    'borderStyle'?: string | (typeof ShapeStyleForUpdate.BorderStyleEnum)[keyof typeof ShapeStyleForUpdate.BorderStyleEnum];
    /**
    ...
    'fontSize'?: string;
    /**
     * Defines how the sticky note text is horizontally aligned. Default:  Flowchart shapes: `center`. Basic shapes: `left`.
     */
    'textAlign'?: string | (typeof ShapeStyleForUpdate.TextAlignEnum)[keyof typeof ShapeStyleForUpdate.TextAlignEnum];
    /**
     * Defines how the sticky note text is vertically aligned. Default:  Flowchart shapes: `middle`. Basic shapes: `top`.
     */
    'textAlignVertical'?: string | (typeof ShapeStyleForUpdate.TextAlignVerticalEnum)[keyof typeof ShapeStyleForUpdate.TextAlignVerticalEnum];
    /** @ignore */
...
export declare namespace ShapeStyleForUpdate {
