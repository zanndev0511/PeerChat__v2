 ...
 */
export declare class CustomFieldPlatformTags {
    /**
     ...
     */
    'iconShape'?: string | (typeof CustomFieldPlatformTags.IconShapeEnum)[keyof typeof CustomFieldPlatformTags.IconShapeEnum];
    /**
...
export declare namespace CustomFieldPlatformTags {
    const IconShapeEnum: {
