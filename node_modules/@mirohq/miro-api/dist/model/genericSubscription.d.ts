...
export declare class GenericSubscription {
    /**
     ...
     */
    'status'?: string | (typeof GenericSubscription.StatusEnum)[keyof typeof GenericSubscription.StatusEnum];
    /**
...
export declare namespace GenericSubscription {
    const StatusEnum: {
