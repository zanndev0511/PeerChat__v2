...
exports.ShapeStyleForUpdate = void 0;
/**
 * @internal
 ...
 */
class ShapeStyleForUpdate {
    /** @ignore */
    static getAttributeTypeMap() {
        return ShapeStyleForUpdate.attributeTypeMap;
    }
}
exports.ShapeStyleForUpdate = ShapeStyleForUpdate;
/** @ignore */
ShapeStyleForUpdate.discriminator = undefined;
/** @ignore */
ShapeStyleForUpdate.attributeTypeMap = [
    {
        name: 'borderColor',
...
(function (ShapeStyleForUpdate) {
    ShapeStyleForUpdate.BorderStyleEnum = {
        Normal: 'normal',
        Dotted: 'dotted',
        Dashed: 'dashed',
    };
    ShapeStyleForUpdate.FontFamilyEnum = {
        Arial: 'arial',
    ...
    ShapeStyleForUpdate.TextAlignEnum = {
        Left: 'left',
        Right: 'right',
        Center: 'center',
    };
    ShapeStyleForUpdate.TextAlignVerticalEnum = {
        Top: 'top',
        Middle: 'middle',
        Bottom: 'bottom',
    };
})(ShapeStyleForUpdate = exports.ShapeStyleForUpdate || (exports.ShapeStyleForUpdate = {}));
