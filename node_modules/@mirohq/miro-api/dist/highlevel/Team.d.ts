...
/** @hidden */
export declare abstract class BaseTeam extends Team {
     ...
     */
    getAllTeamMembers(query?: Omit<Parameters<MiroApi['enterpriseGetTeamMembers']>[2], 'cursor'>): AsyncGenerator<TeamMember, void>;
}
